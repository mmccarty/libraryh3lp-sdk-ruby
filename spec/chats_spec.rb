...
describe Chats do
  it "list all chats for a given day" do
    ...
    stub_request(:get, "https://unittest.libraryh3lp.com/2011-12-03/conversations/2013/07/03?format=json").
      ...
      to_return(:status => 200, :body => '[{"chat": 1}, {"chat": 2}]', :headers => {})
  ...
  it "anonymizes a give chat" do
    ...
    stub_request(:post, "https://unittest.libraryh3lp.com/2011-12-03/conversations/anonymize-conversations").
      with(:body => {"ids"=>"1,2,3"},
           :headers => {'Accept'=>'*/*; q=0.5, application/xml', 'Accept-Encoding'=>'gzip, deflate', 'Content-Length'=>'13', 'Content-Type'=>'application/x-www-form-urlencoded', 'User-Agent'=>'Ruby'}).
  ...
  it "archive conversations" do
    ...
    stub_request(:get, "https://unittest.libraryh3lp.com/2011-12-03/conversations/archive?ids=1,2,3").
      with(:headers => {'Accept'=>'*/*; q=0.5, application/xml', 'Accept-Encoding'=>'gzip, deflate', 'Content-Type'=>'plain', 'User-Agent'=>'Ruby'}).
      to_return(:status => 200, :body => "here you go", :headers => {})
